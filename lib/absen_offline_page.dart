...
final distance =
                            ...
                            SizedBox(
                              ...
                              child: GoogleMap(
                                ...
                                initialCameraPosition: CameraPosition(
                                  target: LatLng(kantorCoordinates.latitude,
                                ...
                                markers: {
                                  Marker(
                                    ...
                                    position: LatLng(kantorCoordinates.latitude,
                                        kantorCoordinates.longitude),
                                    infoWindow:
                                        const InfoWindow(title: 'Lokasi Absen'),
                                  ),
                                  Marker(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: checkStatus == '0-0' && isLoading == false ||
                              isLoading == false &&
                                  checkStatus != '0-0' &&
                                  checkStatus != 'A-A'
                          ? () {
  ...
  void _saveAbsenData(
      status, empId, note, foto, shift, condition, nama, dateTime) async {
